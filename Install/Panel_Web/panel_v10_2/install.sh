...
sleep 1
cd
wget https://github.com/cerberus9116/multi/blob/master/Install/Panel_Web/panel_v10_2/ssh.sql > /dev/null 2>&1
sleep 1
...
echo -e "\033[1;37mwget https://github.com/cerberus9116/multi/blob/master/Install/Panel_Web/panel_v10/revenda/confpainel/inst && bash inst\033[0m"
